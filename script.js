...
socket.on("nameAccepted", (acceptedName) => {
  ...
  if (isFirstLogin) {
    ...
    addSystemHintMessage("🎵 უკვე შეგიძლიათ მოუსმინოთ მუსიკას ერთდროულად რაც მთავარია კომფორტულად!  ⚠️⚠️⚠️⚠️ სამწუხაროდ ამ სერვისის გამოყენება მხოლოდ ანდროიდის მომხმარებლებს შეუძლიათ ამ ეტაპზე  :(  ისიამოვნეთ 😌🎧", "system-message-hint--music");
